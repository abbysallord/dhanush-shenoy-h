...
const PROJECTS = [
  ...
  },
  {
    id: '02',
    title: 'checkDK',
    subtitle: 'power up your DevOps',
    desc: 'This tool will help DevOps engineers with proactive monitoring and prediction of cluster failures, thereby saving themselves a lot of time. Available in npmjs.com and pypi.org',
    tags: ['React', 'Tailwind', 'AWS', 'FastAPI', 'ML', 'PyTorch', 'JWT'],
