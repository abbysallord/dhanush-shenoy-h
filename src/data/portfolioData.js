...
export const PROJECTS = [
  {
    id: '01',
    title: 'Bunkim',
    subtitle: 'Precision Attendance Cushion & Bunk Calculator',
    desc: 'An offline-first, client-side attendance buffer calculator that computes safe bunk margins, recovery targets, and multi-subject rosters for college students.',
    problem: 'College students struggle with calculating threshold margins, risking attendance shortage or unnecessary stress.',
    solution: 'Built a reactive cushion calculation engine with multi-subject roster tracking, custom thresholds (75%, 80%, 85%), and local storage persistence.',
    impact: 'Empowers students to optimize self-study and hackathon participation while staying safely above debarment criteria.',
    tags: ['React', 'TypeScript', 'Tailwind CSS', 'Vite', 'PWA', 'Local-First'],
    github: 'https://github.com/abbysallord/bunkim',
    live: 'https://bunkim.dshenoyh.in/',
    featured: true,
    year: '2026',
    accent: '#ff5722',
  },
  ...
  },
  {
    id: '03',
    title: 'Oppy',
    subtitle: 'Terminal-Native Opportunity Scout & Indexer',
    desc: 'A local-first CLI utility and resume compatibility auditor that aggregates remote internships and hackathons into local SQLite caches and Obsidian second-brain vaults.',
    problem: 'Traditional career portals are cluttered with ads and tracking, making discovery fragmented and inefficient.',
    solution: 'Built a Python/Node CLI that crawls public APIs, prunes expired listings, audits local resumes, and exports clean Markdown/PDF dashboards.',
    impact: 'Automates job discovery with zero cloud telemetry and instant terminal execution via npx.',
    tags: ['Python', 'Node.js', 'SQLite', 'Rich TUI', 'Obsidian', 'CLI Tool'],
    github: 'https://github.com/abbysallord/oppy',
    live: 'https://oppy.dshenoyh.in/',
    featured: true,
    year: '2026',
    accent: '#00ff85',
  },
